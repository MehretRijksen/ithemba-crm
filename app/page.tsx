  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center px-4">
      <div className="max-w-2xl w-full text-center space-y-8">
        <div>
          <h1 className="text-4xl font-bold text-white mb-2">Ithemba Kuluntu</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-10">
          <Link
            href="/dashboard"
            className="bg-green-700 hover:bg-green-600 transition rounded-xl p-6 text-left"
          >
          ...
          <Link
            href="/partner/nieuw"
            className="bg-blue-700 hover:bg-blue-600 transition rounded-xl p-6 text-left"
          >
            <div className="text-2xl mb-2">➕</div>
